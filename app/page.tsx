              ...
              <div className="relative">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { num: '04', role: 'Algorithm', color: '#818cf8', title: 'Optimizes the plan',   desc: 'After clicking "Optimize", the genetic algorithm (80 individuals × 60 generations) builds the optimal distribution in seconds.' },
